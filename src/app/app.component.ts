...
export class AppComponent {
    ...
    @ViewChild('ownerOneObj', {static: false}) ownerOneObj: CheckBoxComponent;
    @ViewChild('ownerTwoObj', {static: false}) ownerTwoObj: CheckBoxComponent;
    @ViewChild('ownerThreeObj', {static: false}) ownerThreeObj: CheckBoxComponent;
